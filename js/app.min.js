(() => {
      ...
      if (
        ...
        e.length
          ? (this.paralaxMouseInit(e),
            this.setLogging(`Прокинувся, стежу за об'єктами: (${e.length})`))
    ...
    paralaxMouseInit(e) {
      e.forEach((e) => {
        ...
        !(function t() {
          (o += ((d - o) * a) / 1e3),
            (l += ((c - l) * a) / 1e3),
            (e.style.cssText = `transform: translate3D(${(r * o) / (s / 10)}%,${
              (n * l) / (i / 10)
            }%,0) rotate(0.02deg);`),
  ...
  var H = {
    ...
    updateSlides: function () {
      ...
      if (
        ...
        E && e.grid.updateWrapperSize(C, u),
        !s.centeredSlides)
      ) {
        const t = [];
  ...
  function K(e) {
    ...
    l.matches(r.focusableElements) &&
      ((g = !1), "SELECT" === l.nodeName && (r.isTouched = !1)),
      s.activeElement &&
  ...
  function Z(e) {
    ...
    if (p > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (y >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? g : m + b)
          : t.slideTo(m)),
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const h = o.direction && o.direction !== i.direction,
            ...
            f = i.loop;
          h && s && e.changeDirection(), T(e.params, o);
  ...
  class ce {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = k(M(t, `.${s.slideClass}, swiper-slide`)[0]);
      return k(e) - i;
    }
  ...
  const he = document.querySelector(".hero"),
    me = [
      {
        element: document.querySelector(".hero__parallax-item--bg"),
        factor: 1.2,
      },
      {
      ...
      {
        element: document.querySelector(".hero__parallax-item--middle"),
        factor: 1.6,
      },
      { element: document.querySelector(".hero__container"), factor: 4 },
    ],
    fe = 1.2 * he.offsetHeight;
  let ge = 0,
    ve = !1;
  function we() {
    const e = Math.min(ge / fe, 1);
    me.forEach(({ element: t, factor: s }) => {
      t.style.transform = `translateY(${(e * fe) / s}px)`;
    }),
      (ve = !1);
  }
  window.addEventListener("scroll", function () {
    (ge = window.scrollY),
      !ve && ge <= fe && ((ve = !0), requestAnimationFrame(we));
  }),
        ...
        function o(e) {
          ...
          if (
            ...
            const e = t.closest("summary"),
              ...
              o = r.hasAttribute("data-spoller-scroll"),
              d = n.dataset.spollersSpeed
            ...
            if (
              ...
              const e = r.dataset.spollerScroll,
                t = +e ? +e : 0,
                s = r.hasAttribute("data-spoller-scroll-noheader")
          ...
          e.addEventListener("click", () => {
            ...
            if (t) {
              const s = t
                  ...
                  .textContent.trim(),
                i = t.querySelector("[data-cnHint]");
              async function r(e) {
                try {
                  await navigator.clipboard.writeText(e);
                } catch (e) {
                  i.textContent = "Doesn't copied";
                } finally {
                  setTimeout(() => {
